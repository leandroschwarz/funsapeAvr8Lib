...
#   elif __FUNSAPE_AVR_SEVEN_SEGMENTS_DISPLAY_HPP != 220
...
uint8_t convertToSevenSegments(uint8_t numericValue_p, cbool_t point_p, SevenSegmentsDisplayType displayType_p)
{
    uint8_t auxData = 0;

    switch (numericValue_p) { //                            PGFEDCBA
