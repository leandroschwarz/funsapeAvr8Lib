...
#   error "Header file (gpioBus.hpp) is corrupted!"
#elif __GPIO_BUS_HPP != __HD44780_HPP
#   error "Version mismatch between header file and library dependency (gpioBus.hpp)!"
#endif

#include "../peripheral/gpioPin.hpp"
#if !defined(__GPIO_PIN_HPP)
#   error "Header file (gpioPin.hpp) is corrupted!"
#elif __GPIO_PIN_HPP != __HD44780_HPP
